...
const Header = () => {
  ...
  return (
    <div className="page">
      <div className="games-promo-bg">
        <div className="games-promo-content">
          <h2>Discover & Play Exciting Games!</h2>
          <p>
            Visit our new Games section for the best online games. Dive into fun now!
          </p>
          <a href="/games" className="games-promo-btn">
            Explore Games
          </a>
        </div>
      </div>
